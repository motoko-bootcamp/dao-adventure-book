...
[source](https://motoko-book.dev/base-library/data-structures/list.html)

Read about Lists and Recursive types [here](https://motoko-book.dev/advanced-types/recursive-types.html).
